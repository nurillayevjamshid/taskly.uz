        ...
        {activeView === 'dashboard' ? (
          <div className="flex-1 overflow-y-auto px-6 py-6 custom-scrollbar">
            <div className="max-w-7xl mx-auto">
              ...
              {/* Desktop: Show message or redirect to board */}
              <div className="hidden md:flex items-center justify-center h-64">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Boshqaruv paneli</h3>
                  <p className="text-gray-500 mb-4">Barcha vazifalar jadval ko'rinishida ko'rsatilgan</p>
                  <button 
